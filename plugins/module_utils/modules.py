...
module as shown below.
  ...
  module = CipherTrustCryptoModule(argument_spec=dictionary, supports_check_mode=boolean
                            mutually_exclusive=list1, required_together=list2)

The 'CipherTrustCryptoModule' module provides similar, but more restricted,
...
class CipherTrustCryptoModule:
    """An ansible module class for CipherTrust modules
    CipherTrustCryptoModule provides an a class for building modules which
    ...
    def __init__(self, **kwargs):
        local_settings = {}
        for key in CipherTrustCryptoModule.default_settings:
            try:
                local_settings[key] = kwargs.pop(key)
            except KeyError:
                local_settings[key] = CipherTrustCryptoModule.default_settings[key]
        ...
        self._module = CipherTrustCryptoModule.default_settings["module_class"](**kwargs)
